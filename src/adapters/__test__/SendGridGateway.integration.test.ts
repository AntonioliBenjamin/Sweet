...
describe('Integration - SendGridGateway', () => {
    ...
    it('Should send feedback', async () => {
        ...
        expect(spyOnSendMethod).toHaveBeenCalledWith({"dynamicTemplateData": { "from": "email", "message": "Hello, j'adore l'app"}, "from": {"email": "cedric@hello.com", "name": "Sweet Dev"}, "templateId": "d-3446010a8e8c4e18859dac0eae658c0a", "to": "cedric@hello.com"});
    })
