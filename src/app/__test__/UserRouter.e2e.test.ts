...
import {
  ...
  dropCollections,
  dropDB,
} from "../../adapters/__test__/setupTestDb";
import {
  createExpressServer,
  useContainer,
  useExpressServer,
...
describe("E2E - User Router", () => {
  ...
  beforeAll(async () => {
    ...
    const bcryptGateway: BcryptGateway = container.get(identifiers.PasswordGateway)
  ...
  it("Should patch/user", async () => {
    ...
    await supertest(app)
      ...
      .expect((response) => {
        ...
        expect(responseBody.schoolId).toEqual(
          "3f5f3ce518a5fd5873ce5b543f560e9bf759a5db"
        );
  ...
  it("Should patch/user/push-token", async () => {
    ...
    await supertest(app)
      ...
      .expect((response) => {
        const responseBody = response.body;
        expect(responseBody.pushToken).toEqual(
          "3f5f3ce518a5fd5873ce5b543f560e9bf759a5db"
        );
      })
      .expect(200);
