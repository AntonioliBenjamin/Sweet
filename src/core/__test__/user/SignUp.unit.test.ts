...
describe("Unit - SignUp", () => {
    ...
    beforeAll(() => {
        ...
        const inMemorySchoolRepository = new InMemorySchoolRepository();
        const uuidGateway = new UuidGateway();
        const bcryptGateway = new BcryptGateway();
        signUp = new SignUp(inMemoryUserRepository, inMemorySchoolRepository, uuidGateway, bcryptGateway);
    });
